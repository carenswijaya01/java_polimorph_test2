...
public class Tester {
	...
	public static void terCepat() {
		if(cekAnjing) {
	        ...
	        for (int i = 1; i < ar.size(); i++){
	            if (ar.get(i).getAtribut(0) > ar.get(cepat).getAtribut(0)){
	                cepat = i;
	            }
	        }
	        System.out.println("Anjing tercepat adalah " + ar.get(cepat).Nama + " dengan kecepatan : " + ar.get(cepat).getAtribut(0) + " (mph)");
		}else {
	...
	public static void terBerat() {
		if(cekKucing) {
			int berat = 0;
	        for (int i = 1; i < ar.size(); i++){
	            if (ar.get(i).getAtribut(1) > ar.get(berat).getAtribut(1)){
	                berat = i;
	            }
	        }
	        System.out.println("Kucing terberat adalah " + ar.get(berat).Nama + " dengan berat : " + ar.get(berat).getAtribut(1) + " (kg)");
		}else {
	...
	public static void main(String[] args) {
		...
		do 
		{
			...
			case 1:
				...
				System.out.print("Masukkan kecepatan: ");a.setAtribut(0, s.nextInt());
				cekAnjing = true;
				i++;
				ar.add(a);
				break;
			case 2:
				...
				System.out.print("Masukkan berat: ");k.setAtribut(1, s.nextInt());
				cekKucing = true;
				i++;
				ar.add(k);
				break;
